...
import 'jquery'
import HomeHero from '@/components/Home/HomeHeroOffersAquitaine'
import OffersList from '@/components/OffersAquitaineList'
...
export default {
  ...
  head () {
    return {
      name: 'OffersBretagne',
      title:
        'Séjournez en Nouvelle-Aquitaine',
      titleTemplate: '%s - AgriVillage',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$t('home.meta.aquitaine')
        }
      ]
    }
  },
