...
import 'jquery'
import HomeHero from '@/components/Home/HomeHeroOffersHost'
import OffersList from '@/components/OffersHostList'
...
export default {
  ...
  head () {
    return {
      name: 'OffersHost',
      title: "Chambre d'hôte à la ferme, séjournez chez un agriculteur",
      titleTemplate: '%s',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$t('home.meta.host')
        }
      ]
    }
  },
