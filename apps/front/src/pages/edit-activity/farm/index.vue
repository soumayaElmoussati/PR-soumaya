<template>
  <div class="edit-farm side">
    ...
    <p class="subtitle">
      {{ $t("activity.paragraphs.operation") }}
    </p>
    ...
    >
      ...
      <p class="subtitle">
        {{ $t("activity.paragraphs.operationType") }}
      </p>
      <farm-type-select
        v-validate="'required'"
      ...
      <p class="subtitle">
        {{ $t("activity.paragraphs.farmingType") }}
      </p>
      ...
      <p class="subtitle">
        {{ $t("activity.paragraphs.petsSelect") }}
      </p>
      <animal-select
      ...
      <p class="subtitle">
        <strong>{{ $t("activity.paragraphs.agritourismShare") }}</strong>
      </p>
      ...
      <p class="subtitle">
        {{ $t("activity.paragraphs.adjective") }}
      </p>

      <p class="subtitle">
        {{ $t("activity.paragraphs.target") }}
      </p>
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.data = {
        description: this.getCurrentActivity.description.activities,
        ...
        agricultureTypes: [],
        activities: [],
        farmDescription: this.getCurrentActivity.description.farm
      }
      this.data.activitiesIndex = {
        discovery: this.getCurrentActivity.description.discovery,
        meeting_animals: this.getCurrentActivity.description.meeting_animals,
        milking_animals: this.getCurrentActivity.description.milking_animals,
        tasting: this.getCurrentActivity.description.tasting,
        birth_animal: this.getCurrentActivity.description.birth_animal,
        stroll: this.getCurrentActivity.description.stroll,
        harvest: this.getCurrentActivity.description.harvest,
        craft: this.getCurrentActivity.description.craft
      }

      this.data.tagsIndex = this.getCurrentActivity.tag

      if (typeof (this.getCurrentActivity.tag) === 'undefined') {
        this.getCurrentActivity.tag = {}
      }
          ...
          .then(valid => {
            ...
            this.$axios.put(`/activities/${this.$route.params.id}`, {
              activity: {
                ...
                activity_agriculture_type: agricultures,
