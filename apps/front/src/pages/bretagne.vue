...
import 'jquery'
import HomeHero from '@/components/Home/HomeHeroBretagne'
import ActivitiesFooter from '@/components/OffersList/OffersFooter'
import ActivitiesList from '@/components/ActivitiesBretagneList'
