...
import 'jquery'
import HomeHero from '@/components/Home/HomeHeroOffersInsolit'
import OffersList from '@/components/OffersInsolitList'
...
export default {
  ...
  head () {
    return {
      name: 'OffersInsolit',
      title: 'Séjour insolite à la ferme chez un agriculteur',
      titleTemplate: '%s - AgriVillage',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$t('home.meta.insolit')
        }
      ]
    }
  },
