    ...
    <div class="edit-wrap">
      <div class="side">
        ...
        <form @submit.prevent="submitted">
          <h2 class="headline">
            {{ $t("offer.titles.specifiedEquipment") }}
          </h2>

          <benefit-select v-model="data.benefits" />
          ...
          <service-select v-model="data.services" />
          ...
          <fieldset v-if="Array.isArray(data.services)">
            <div class="offer-service__price__fields">
              ...
              <label
                v-if="data.services.includes('breakfast')"
                class="label"
              >{{ $t("offer.infos.breakfastPrice") }}</label
              >

              <p
                v-if="data.services.includes('breakfast')"
                class="caption">
                {{ $t("offer.paragraphs.stayPrice") }}
              </p>
              <wi-input
            ...
            <div class="offer-service__linens__fields">
              ...
              <label
                v-if="data.services.includes('linens')"
                class="label"
              >{{ $t("offer.infos.linenPrice") }}</label
              >
            ...
            <div class="offer-service__cleaning__fields">
              ...
              <label
                v-if="data.services.includes('cleaning')"
                class="label">{{ $t("offer.infos.cleaningPrice") }}</label>
          ...
          <div class="buttons">
            ...
            <button
              ...
              class="btn btn-agri-yellow"
            >
              <span v-if="!$wait.is('updating housing')">
...
export default {
  ...
  mounted () {
    ...
    this.data.servicesIndex.breakfast_price = Math.round(
      this.data.servicesIndex.breakfast_price / 100
    )
    this.data.servicesIndex.linens_price = Math.round(
      this.data.servicesIndex.linens_price / 100
    )
    this.data.servicesIndex.cleaning_price = Math.round(
      this.data.servicesIndex.cleaning_price / 100
    )
    this.data.servicesIndex.host_table_price = Math.round(
      this.data.servicesIndex.host_table_price / 100
    )
