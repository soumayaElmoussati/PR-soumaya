...
import 'jquery'
import HomeHero from '@/components/Home/HomeHeroOffersLodge'
import OffersList from '@/components/OffersLodgeList'
...
export default {
  ...
  head () {
    return {
      name: 'OffersLodge',
      title: 'Gîte à la ferme, séjournez chez un agriculteur',
      titleTemplate: '%s - AgriVillage',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$t('home.meta.lodge')
        }
      ]
    }
  },
