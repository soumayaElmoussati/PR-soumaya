...
import 'jquery'
import HomeHero from '@/components/Home/HomeHeroOffersNormandie'
import OffersList from '@/components/OffersNormandieList'
...
export default {
  ...
  head () {
    return {
      ...
      title: 'Séjournez en Normandie, redécouvrez les campagnes normandes !',
      titleTemplate: '%s - AgriVillage',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$t('home.meta.normandie')
        }
      ]
    }
  },
