<template>
  <div class="equipment-select">
    ...
    <h6 class="headline">{{ $t("offer.titles.fun") }}</h6>
    ...
    <h6 class="headline">{{ $t("offer.titles.health") }}</h6>
    ...
    <h6 class="headline">{{ $t("offer.titles.comfort") }}</h6>
    ...
    <h6 class="headline">{{ $t("offer.titles.cooking") }}</h6>
    ...
    <h6 class="headline">{{ $t("offer.titles.serenity") }}</h6>
