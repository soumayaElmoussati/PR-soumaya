      ...
      <div
        ...
        <div class="wrap">
          <h1
            ...
            <b>{{ $t("home.titles.breton") }}</b> <br> {{ $t("home.titles.discoveryBreton") }} <br> {{ $t("home.titles.exploitationBreton") }} <br> <b>{{ $t("home.titles.bretonne") }}</b>
          </h1>
        </div>
      </div>
...
<style lang="scss" scoped>
  ...
  .home-hero{
    ...
    &__image{
      ...
      background-image: url('~assets/img/home/bretagne.png');
      background-size: cover;
