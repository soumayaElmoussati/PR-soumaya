      ...
      <div
        ...
        <div class="wrap">
          <h1
            ...
            <b>{{ $t("home.titles.normandie") }}</b> <br> {{ $t("home.titles.selection") }} <br> {{ $t("home.titles.exploitation") }} <br> <b>{{ $t("home.titles.normand") }}</b>
          </h1>
        </div>
      </div>
...
<style lang="scss" scoped>
  ...
  .home-hero{
    ...
    &__image{
      ...
      background-image: url('~assets/img/home/host.png');
      background-size: cover;
