    ...
    <div
      ...
      <div class="wrap">
        <h1
          ...
          <b>{{ $t("home.titles.reserved") }}</b><br>{{ $t("home.titles.an") }} {{ $t("home.titles.activity") }} <br> <b>{{ $t("home.titles.agri") }}</b>
        </h1>
        <form
...
<style lang="scss" scoped>
  ...
  .home-hero{
    ...
    &__image{
      ...
      background-image: url('~assets/img/home/activities-background.jpg');
      background-size: cover;
