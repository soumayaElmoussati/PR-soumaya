<template>
  ...
  <div
    ...
    <div class="offers-list-header">
      <h1 style="font-size: 26px">{{ $t("offer.paragraphs.guest")[0] }}</h1>
      <p class="text-center seo-quote">
        {{ $t("offer.paragraphs.guest")[1] }}<br>
        {{ $t("offer.paragraphs.guest")[2] }}<br>
        {{ $t("offer.paragraphs.guest")[3] }}<br>
        {{ $t("offer.paragraphs.guest")[4] }}<br>
        {{ $t("offer.paragraphs.guest")[5] }}<br>
        {{ $t("offer.paragraphs.guest")[6] }}
      </p>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        housingList: [
          ...
          { value: 'immersive_house', name: 'Logement immersif' }
        ],
        housings: [],
        agricultureList: [
    ...
    methods: {
      ...
      fetchOffers () {
        this.filter({ residence_type: 'guest_room' })
      }
    }
  }
</script>
