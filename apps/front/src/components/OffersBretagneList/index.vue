<template>
  ...
  <div
    ...
    <div class="offers-list-header">
      <h1>{{ $t("offer.paragraphs.bretagne")[0] }}</h1>
      <p class="text-center seo-quote">
        {{ $t("offer.paragraphs.bretagne")[1] }}<br>
        {{ $t("offer.paragraphs.bretagne")[2] }}<br>
        {{ $t("offer.paragraphs.bretagne")[3] }}<br>
        {{ $t("offer.paragraphs.bretagne")[4] }}<br>
        {{ $t("offer.paragraphs.bretagne")[5] }}<br>
        {{ $t("offer.paragraphs.bretagne")[6] }}<br>
        {{ $t("offer.paragraphs.bretagne")[7] }}<br>
        {{ $t("offer.paragraphs.bretagne")[8] }}
  ...
  export default {
    ...
    data () {
      return {
        ...
        zoom: 6,
        center: [48.202047, -2.932644], // NOTE: Center of Bretagne
        seen: true,
        housingList: [
