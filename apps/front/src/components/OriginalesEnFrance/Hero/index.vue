      ...
      <div class="home-hero__image h_small">
        <div class="wrap">
          <h1
            ...
            {{ $t("originalesEnFrance.hero.titleHero") }}
          </h1>
        </div>
      </div>
    </div>
...
.home-hero {
  background-image: linear-gradient(rgba(40, 58, 38, 0.5), rgba(46, 60, 45, 0.3)), url("~assets/img/originalesEnFrance/head.png");
...
// }
// #s1 {
//   background-image: url("~assets/img/VacancesEnFamille/hero.png");
// }
// #s2 {
//   background-image: url("~assets/img/VacancesEnFamille/hero.png");
// }
...
//       url("~assets/img/VacancesEnFamille/hero.png");
//     background-size: cover;
//     background-position: center;
