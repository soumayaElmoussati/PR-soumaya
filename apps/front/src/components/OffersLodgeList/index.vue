  ...
  <div
    ...
    <div class="offers-list-header">
      <p class="text-center seo-quote">
        {{ $t("offer.paragraphs.stayed")[0] }}<br>
        {{ $t("offer.paragraphs.stayed")[1] }}<br>
        {{ $t("offer.paragraphs.stayed")[2] }}<br>
        {{ $t("offer.paragraphs.stayed")[3] }}<br>
        {{ $t("offer.paragraphs.stayed")[4] }}<br>
        {{ $t("offer.paragraphs.stayed")[5] }}<br>
        {{ $t("offer.paragraphs.stayed")[6] }}
      </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fetchOffers () {
        this.filter({ residence_type: 'entire_house' })
      }
    }
  }
</script>
