<template>
  <div
    ...
    class="equipments-filter cust cust-fullsearch"
  >
    <div class="equipments-filter__field">
      <button
        type="button"
        class="equipments-filter__field__button"
        @click="dialogOpen = true"
      >
        {{ $t("offer.buttons.equipment") }}
      </button>
    </div>
...
<script>
  import EquipmentFilter from '@/components/Home/EquipmentFilter'
