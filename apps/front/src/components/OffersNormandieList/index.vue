  ...
  <div
    ...
    <div class="offers-list-header">
      <p class="text-center seo-quote">
        {{ $t("offer.paragraphs.normand")[0] }}<br>
        {{ $t("offer.paragraphs.normand")[1] }}<br>
        {{ $t("offer.paragraphs.normand")[2] }}<br>
        {{ $t("offer.paragraphs.normand")[3] }}<br>
        {{ $t("offer.paragraphs.normand")[4] }}<br>
        {{ $t("offer.paragraphs.normand")[5] }}<br>
        {{ $t("offer.paragraphs.normand")[6] }}
      </p>
  ...
  export default {
    ...
    data () {
      return {
        ...
        zoom: 6,
        center: [48.879870, 0.171253], // NOTE: Center of Normandie
        seen: true,
        housingList: [
