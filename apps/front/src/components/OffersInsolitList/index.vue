  ...
  <div
    ...
    <div class="offers-list-header">
      <p class="text-center seo-quote">
        {{ $t("offer.paragraphs.tinyHouse")[0] }}<br>
        {{ $t("offer.paragraphs.tinyHouse")[1] }}<br>
        {{ $t("offer.paragraphs.tinyHouse")[2] }}<br>
        {{ $t("offer.paragraphs.tinyHouse")[3] }}<br>
        {{ $t("offer.paragraphs.tinyHouse")[4] }}<br>
        {{ $t("offer.paragraphs.tinyHouse")[5] }}
      </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fetchOffers () {
        this.filter({ residence_type: 'unusual_room' })
      }
    }
  }
</script>
