<template>
  ...
  >
    ...
    >
      ...
      <nuxt-link :to="{ name: 'EditActivityActivity', params: { id: activity.id }}">

        <div class="edit-offer">
          <img
            alt="edit"
            src="@/assets/img/offer/edit.png"
            class="edit-icon"
            width="15"
            height="15">
        </div>
    ...
    <div class="offer-card-informations">
      ...
      <div class="infos-secondary">
        {{ people }} {{ $t('activity.titles.personYea') }}
      </div>
      ...
      <div class="infos-price">
        <p>
          {{ $t('activity.paragraphs.from') }} <span class="price">{{ getBasePrice | currency }}</span>
        </p>
      </div>
